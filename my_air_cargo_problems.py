...
def add_propositions(relation:str, obj1:list, obj2:list, all_obj2:list, pos, neg):
    """
...
def air_cargo_p2() -> AirCargoProblem:
    ...
    # Cargos at airports
    add_propositions('At', ['C1'], ['SFO'], airports, pos, neg)
    add_propositions('At', ['C2'], ['JFK'], airports, pos, neg)
    add_propositions('At', ['C3'], ['ATL'], airports, pos, neg)

    # Planes at airports
    add_propositions('At', ['P1'], ['SFO'], airports, pos, neg)
    add_propositions('At', ['P2'], ['JFK'], airports, pos, neg)
    add_propositions('At', ['P3'], ['ATL'], airports, pos, neg)

    # None of the cargos are loaded on any plane
    add_propositions('In', cargos, [], planes, pos, neg)
...
def air_cargo_p3() -> AirCargoProblem:
    ...
    add_propositions('At', ['C2'], ['JFK'], airports, pos, neg)
    add_propositions('At', ['C3'], ['ATL'], airports, pos, neg)
    add_propositions('At', ['C4'], ['ORD'], airports, pos, neg)
